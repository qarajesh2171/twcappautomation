...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - RETAKE HRA text</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'RETAKE HRA' or . = 'RETAKE HRA')]</locator>

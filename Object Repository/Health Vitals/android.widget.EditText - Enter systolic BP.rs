...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - Enter systolic BP</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Enter systolic BP' or . = 'Enter systolic BP')]</locator>

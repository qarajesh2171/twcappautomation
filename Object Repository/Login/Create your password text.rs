...
<MobileElementEntity>
   ...
   <name>Create your password text</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Create your password!' or . = 'Create your password!')]</locator>

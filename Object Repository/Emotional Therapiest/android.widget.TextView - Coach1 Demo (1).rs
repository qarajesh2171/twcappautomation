...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Coach1 Demo (1)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Coach1 Demo' or . = 'Coach1 Demo')]</locator>

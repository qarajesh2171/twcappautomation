...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Add Breakfast</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Add Breakfast' or . = 'Add Breakfast')]</locator>

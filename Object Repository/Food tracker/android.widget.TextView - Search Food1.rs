...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Search Food1</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Search Food' or . = 'Search Food')]</locator>

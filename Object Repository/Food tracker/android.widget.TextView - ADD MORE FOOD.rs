...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - ADD MORE FOOD</name>
   <tag></tag>
   <elementGuidId>74151718-bedd-4543-88d4-58e7ec97574b</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'ADD MORE FOOD' or . = 'ADD MORE FOOD')]</locator>

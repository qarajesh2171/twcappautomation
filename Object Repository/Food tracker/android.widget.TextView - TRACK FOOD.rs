...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - TRACK FOOD</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'TRACK FOOD' or . = 'TRACK FOOD')]</locator>

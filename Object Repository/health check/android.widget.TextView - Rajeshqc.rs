...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Rajeshqc</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Rajeshqc' or . = 'Rajeshqc')]</locator>

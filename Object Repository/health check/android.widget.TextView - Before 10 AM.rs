...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Before 10 AM</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Before 10 AM' or . = 'Before 10 AM')]</locator>

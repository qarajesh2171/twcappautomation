...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - SCHEDULE PICKUP</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'SCHEDULE PICKUP' or . = 'SCHEDULE PICKUP')]</locator>
